...
To get NFTs for this wallet, use the faucet at: `chainbois-testnet-faucet.vercel.app` — click **Connect Wallet** (choose your wallet if multiple are installed), and the faucet will automatically add Avalanche Fuji to your wallet and switch to it. Wallet connection is required to claim.
