...
Our first title is a multiplayer third-person shooter already live on Fuji Testnet with 7 game modes, NFT character progression, a deflationary $BATTLE token, and automated tournaments. This game proves our core thesis: that blockchain should make gaming more valuable, not more complicated.

In 1-2 years, we see ChainBois as:

- **A multi-title gaming studio** where $BATTLE and ChainBoi NFTs carry value across games — your rank, weapons, and competitive identity travel with you between titles
...
- **A reference implementation for sustainable Web3 gaming economics** — our dynamic tokenomics system (health tiers, auto-burn, self-regulating conversion rates) is studio-level infrastructure that scales across every future title we ship
...
- Deploy BattleToken, ChainBoisNFT, and WeaponNFT to Avalanche C-Chain Mainnet
- Mint full 4,032 ChainBoi NFT collection (4,000 public + 32 reserved)
- Launch $BATTLE token with initial DEX liquidity on Trader Joe
- Complete frontend integration for Training Room, Armory, Tournaments, and Inventory
...
We are building for three distinct personas, acquired in sequence:
...
What they want: Download a game, play for free, earn something. Zero blockchain knowledge required.
...
- **Avalanche Ecosystem Activation:** Leverage Build Games exposure, apply for Avalanche Foundation grants and Frontrunners program. Cross-promote with Avalanche gaming ecosystem partners.
...
- **Testnet-to-Mainnet Migration:** Our existing testnet faucet users become first mainnet players — they already have the game installed and understand the mechanics.
...
- **Tournament Discord Integration:** Live tournament leaderboard feeds via Discord webhooks. Real-time winner announcements and prize distributions visible to the entire community. Creates spectator engagement even when not playing.
...
Unlike most Web3 games that rely on continuous token emissions (inflationary death spiral), ChainBois has a FIXED 10M $BATTLE supply that is actively deflationary. Revenue comes from real economic activity (purchases, trades, tournament fees), not from printing new tokens. The dynamic tokenomics system auto-adjusts rates to prevent pool depletion. The more players play, the more $BATTLE is burned, creating natural scarcity without artificial inflation.
...
Our core differentiator is that **gameplay skill directly affects NFT value**. In ChainBois, your character NFT records your wins, kills, tournament placements, and rank progression on-chain. A Level 7 Field Marshal ChainBoi with 500 tournament wins is provably more valuable than a freshly minted one — and that value was created by player skill, not RNG.

No competitor does this:
- **Off The Grid** has impressive scale (13M users) but NFTs are static cosmetic loot items. A weapon doesn't get better because you played well with it.
- **Shrapnel** focuses on creator tools and UGC — players create maps and mods, not competitive progression.
...
1. **Deflationary token design.** $BATTLE has a hard cap of 10M tokens (ERC20Capped) with active burn mechanics. GUN token has 10B supply and dropped 60% post-launch. Our fixed supply + automated burns create structural scarcity. The more players play, the scarcer $BATTLE becomes.

2. **Automated tournament infrastructure.** 9 cron jobs handling tournament lifecycle, prize distribution, score validation, and anti-cheat — all without manual intervention. This scales to thousands of concurrent tournaments.

3. **Web2-to-Web3 bridge.** Players can download and play without a wallet. The blockchain layer is optional but compelling. This eliminates the onboarding friction that kills most Web3 games.

4. **Studio-level infrastructure on Avalanche.** Our backend architecture (dynamic tokenomics, wallet management, purchase failsafes, anti-cheat) is not game-specific — it's platform infrastructure that scales across multiple titles. ChainBois is Title 1 from a gaming studio, not a standalone project.

5. **Cost-efficient positioning.** Off The Grid raised $30M+ and has 450 employees. Shrapnel raised $37M+. Both Nyan Heroes ($11M raised) and Shatterline shut down in 2025 despite significant funding. ChainBois ships with a lean team and sustainable economics — we don't need $30M to survive, we need players who play.
